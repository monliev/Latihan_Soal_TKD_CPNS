...
public class NumberPickerDialogPreference extends DialogPreference
{
    ...
    public NumberPickerDialogPreference(Context context, AttributeSet attrs)
    {
        ...
        setDialogIcon(null);
        setSummary(getFormattedSummary(prefs.getInt(SettingsActivity.PREF_NUM_QUESTIONS, DEFAULT_VALUE)));

        setOnPreferenceChangeListener(new OnPreferenceChangeListener() {

            @Override
            public boolean onPreferenceChange(Preference pref, Object value) {
                pref.setSummary(getFormattedSummary( (Integer) value));
                return true;
            }
        });
    }
    ...
    public String getFormattedSummary(){
        return String.format("%d questions", mValue);
    }
    ...
    public String getFormattedSummary(int n) {

        String questions = mContext.getResources()
                .getQuantityString(R.plurals.question, n, n);
