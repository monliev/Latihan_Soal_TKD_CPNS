package com.infotechnodev.php.persistence;
...
import com.infotechnodev.php.core.Alternative;
import com.infotechnodev.php.core.Category;
import com.infotechnodev.php.core.Question;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private void loadCategoriesFromJSON(SQLiteDatabase db) {
        InputStream inputStream = mContext.getResources().openRawResource(com.infotechnodev.php.R.raw.categories);
